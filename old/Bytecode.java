...
public class Bytecode {
	...
	public static final short HALT = 18;
        public static final short IGT = 19;
        public static final short SCONST = 20;
        public static final short IDIV = 21;
        public static final short MOD = 22;
        public static final short NATIVECALL = 23;
	...
	public static Instruction[] instructions = new Instruction[] {
		...
		new Instruction("halt"),
                new Instruction("igt"),
                new Instruction("sconst",1),
                new Instruction("idiv"),
                new Instruction("mod"),
                new Instruction("nativecall",2)
	};
}
